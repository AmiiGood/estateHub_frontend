...
const PagState = (props) => {
  ...
  const postPago = async (pagoData) => {
    try {
      ...
      const res = await axios.post(
        "http://localhost:3000/api/pagosRenta/postPagoRenta",
        { pagoRenta: pagoData },
        {
          headers: {
  ...
  const getPago = async (idPago) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/pagosRenta/getPagoRenta/${idPago}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const putPago = async (pagoData) => {
    try {
      ...
      const res = await axios.put(
        "http://localhost:3000/api/pagosRenta/putPagoRenta",
        { pagoRenta: pagoData },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const deletePago = async (idPago) => {
    try {
      ...
      const res = await axios.delete(
        `http://localhost:3000/api/pagosRenta/deletePagoRenta/${idPago}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getPagos = async () => {
    try {
      ...
      const res = await axios.get(
        "http://localhost:3000/api/pagosRenta/getPagosRenta",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getPagosPorContrato = async (idContrato) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/pagosRenta/getPagosRentaByContrato/${idContrato}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getPagosPorEstatus = async (estatus) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/pagosRenta/getPagosRentaByEstatus/${estatus}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getPagosPorRangoFechas = async (inicio, fin) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/pagosRenta/getPagosRentaByRangoFechas?inicio=${inicio}&fin=${fin}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const actualizarEstatusPago = async (idPago, estatus) => {
    try {
      ...
      const res = await axios.patch(
        `http://localhost:3000/api/pagosRenta/patchPagoRenta/${idPago}/estatus`,
        { estatus },
        {
          headers: {
            Authorization: `Bearer ${token}`,
