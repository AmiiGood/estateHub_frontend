...
const ContState = (props) => {
  ...
  const getCont = async (idContrato) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/contratos/getContrato/${idContrato}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const deleteCont = async (idContrato) => {
    try {
      ...
      const res = await axios.delete(
        `http://localhost:3000/api/contratos/deleteContrato/${idContrato}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getContratosByUsuario = async (idUsuario) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/contratos/getContratosByUsuario/${idUsuario}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getContratosByPropiedad = async (idPropiedad) => {
    try {
      ...
      const res = await axios.get(
        `http://localhost:3000/api/contratos/getContratosByPropiedad/${idPropiedad}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getContratosActivos = async () => {
    try {
      ...
      const res = await axios.get(
        "http://localhost:3000/api/contratos/getContratosActivos",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const putEstatusContrato = async (idContrato, estatus) => {
    try {
      ...
      const res = await axios.put(
        `http://localhost:3000/api/contratos/putEstatusContrato/${idContrato}`,
        { estatus },
        {
          headers: {
            Authorization: `Bearer ${token}`,
