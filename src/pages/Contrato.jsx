              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-3 py-1 text-xs rounded ${viewMode === "google"
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-xs rounded ${viewMode === "direct"
                      ? "bg-blue-600 text-white"
                      : "bg-gray-700 text-gray-300"
                      }`}
                  >
...
export const loaderContrato = async ({ params }) => {
  ...
  try {
    const res = await fetch(`${import.meta.env.VITE_API_URL}/contratos/getContrato/${params.id}`, { headers });
